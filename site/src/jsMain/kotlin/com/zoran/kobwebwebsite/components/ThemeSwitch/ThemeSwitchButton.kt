package com.zoran.kobwebwebsite.components.ThemeSwitch
...
import com.zoran.kobwebwebsite.CustomStyles.ThemeIconStyle
...
fun ThemeSwitchButton(colorMode: ColorMode, onClick: () -> Unit) {
    ...
    Column(
        ...
        IconButton(
            ...
            iconSize = if (breakPoint > Breakpoint.SM) Resources.Dimens.ICON_SIZE_LG.px else Resources.Dimens.ICON_SIZE.px,
            onClick = onClick
        )
    }
}